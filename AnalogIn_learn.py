...
R = c_double() 
dwf.FDwfAnalogInChannelRangeGet(hdwf, c_int(0), byref(R))
print("Range = ", R.value, "V")#왜 세팅이 안되는거지?
dwf.FDwfAnalogInConfigure(hdwf, c_bool(False), c_bool(False)) 
Range = c_double() 
dwf.FDwfAnalogInChannelRangeGet(hdwf, c_int(0), byref(Range))
print("Range = ", Range.value, "V")
