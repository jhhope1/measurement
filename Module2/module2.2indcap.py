...
tutorial_df = pd.DataFrame({'time' : t, 'V1' : V1_np, 'V2' : V2_np, 'sineoutput_freq' : frequency, 'sineoutput_amplitude':amplitude, 'inductance':inductance, 'capacitance': capacitance})
