...
data = pd.read_csv(data_path+"\\Module2square_2kHz.csv", skiprows=28)
...
plt.legend(loc=0)
plt.savefig(os.path.join(save_path,'opamp_integrate_sqaure.pdf'))
plt.show()
...
plt.legend(loc=0)
plt.savefig(os.path.join(save_path,'opamp_original_sqaure.pdf'))
plt.show()