...
dwf.FDwfAnalogIOChannelNodeSet(hdwf, c_int(0), c_int(1), c_double(V_wheatstone))
...
while(True):
    ...
    print ("oscillo1, oscillo2 = {:.5f}, {:.5f}".format(voltage0.value, voltage1.value))
#------------------------------
...
plt.plot(Power_V_list, Oscillo1_list, label = 'Oscillo1_list')
